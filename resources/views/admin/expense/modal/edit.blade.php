<div class="modal fade" id="modalEditEgresos" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <form id="expenseFormEdit" method="post" enctype="multipart/form-data">
            @csrf
