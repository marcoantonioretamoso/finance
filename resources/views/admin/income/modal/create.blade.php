<div class="modal fade" id="modalCreateIngreso" tabindex="-1" aria-labelledby="exampleModalLabel" data-bs-backdrop="static" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Crear ingreso</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12 mb-6">
                        ...
                        <textarea name="descripcion" class="form-control" id="" cols="3" rows="3" style="resize: none"></textarea>
