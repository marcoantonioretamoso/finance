                    ...
                    @forelse ($loans as $loan)
                        <tr class="odd">
                            ...
                            <td class="text-end">
                                    ...
                                    <a onclick="editIncome(`{{ $loan->id }}`, `{{ $loan->description }}`, `{{ $loan->amount }}`)"class="btn btn-icon btn-flex btn-active-light-primary w-30px h-30px me-3"
                                        data-bs-toggle="tooltip" title="" data-kt-action="product_remove"
                                        data-bs-original-title="Mostrar">
                                        <i class="fa-solid fa-pen"></i>
                                    </a>
                                    <a onclick="deleteIncome(`{{ $loan->id }}`, `{{ $loan->description }}`)"
