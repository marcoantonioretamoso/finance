    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Listado de Prestamos</h1>
            </div>
                  ...
                  {{-- <div class="row mx-5">
                    ...
                    @can('agregar proveedores') --}}
                        ...
                        <a onclick="modalCreateIngreso()" data-bs-toggle="modal" data-bs-target="#modalCreateIngreso" class="btn btn-primary btn-sm">
                            <i class="fa-solid fa-plus"></i> Registrar Prestamos
                        </a>
                    {{-- @endcan --}}
                </div>
            </div>
...
@section('modals')
    ...
    @include('admin.loan.modal.payment')
@endsection
      ...
      let loand_id = 0;
        $(document).ready(function(){
            ...
            $('#incomeFormEdit').submit(function(e) {
                ...
                let formData = new FormData(form);
                $.ajax({
                    url: "{{ url('admin/loans/update') }}/" + income_id,
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
            ...
            $('#paymentForm').submit(function(e) {
                ...
                let formData = new FormData(form);
                formData.append('loand_id', loand_id);
                $.ajax({
                    url: "{{ url('admin/payments/store') }}",
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        function deleteIncome(id, descripcion) {
            confirmar(function() {
                $.ajax({
                    url: "{{ url('admin/loans/destroy') }}/" + id, // URL a la que se enviarán los datos
                    type: 'POST',
                    data: {
                        _token: "{{ csrf_token() }}",
                    },
        ...
        function paymentLoan(id, descripcion, monto) {
            loand_id =  id;
